...
#define AURORA_KCTL_OP_PCI 7u
#define AURORA_KCTL_OP_BLK 8u
#define AURORA_KCTL_OP_PANIC 9u
#define AURORA_KCTL_OP_REBOOT 10u
#define AURORA_KCTL_OP_HALT 11u
#define AURORA_KCTL_OP_ACPI 12u
#define AURORA_KCTL_OP_APIC 13u
...
#define AURORA_KCTL_OP_BOOT 19u
#define AURORA_KCTL_OP_MAX 20u
...
#define AURORA_PROT_READ  0x00000001u
#define AURORA_PROT_WRITE 0x00000002u
#define AURORA_PROT_EXEC  0x00000004u
#define AURORA_PROT_SUPPORTED (AURORA_PROT_READ | AURORA_PROT_WRITE | AURORA_PROT_EXEC)

#define AURORA_MAP_ANON    0x00000001u
#define AURORA_MAP_PRIVATE 0x00000002u
