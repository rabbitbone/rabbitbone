...
- ELF64 user program loading, kernel `#!` interpreter dispatch for scripts, ring3 entry, `int 0x80` syscalls, `/disk0/sbin/init`, and `/disk0/bin/aursh`.
