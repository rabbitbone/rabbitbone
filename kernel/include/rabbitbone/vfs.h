...
typedef enum vfs_status {
    ...
    VFS_ERR_NOMEM = RABBITBONE_ERR_NOMEM,
    VFS_ERR_INVAL = RABBITBONE_ERR_INVAL,
    VFS_ERR_IO = RABBITBONE_ERR_IO,
    VFS_ERR_NOTDIR = RABBITBONE_ERR_NOTDIR,
    VFS_ERR_ISDIR = RABBITBONE_ERR_ISDIR,
    VFS_ERR_EXIST = RABBITBONE_ERR_EXIST,
    VFS_ERR_PERM = RABBITBONE_ERR_PERM,
    VFS_ERR_NOSPC = RABBITBONE_ERR_NOSPC,
    VFS_ERR_NOTEMPTY = RABBITBONE_ERR_NOTEMPTY,
    VFS_ERR_UNSUPPORTED = RABBITBONE_ERR_UNSUPPORTED,
