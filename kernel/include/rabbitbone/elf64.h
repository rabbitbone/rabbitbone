#ifndef RABBITBONE_ELF64_H
#define RABBITBONE_ELF64_H
...
#define ELF64_RABBITBONE_USER_IMAGE_BASE 0x0000010000000000ull
#define ELF64_RABBITBONE_USER_SPACE_LIMIT 0x0000800000000000ull
...
typedef struct RABBITBONE_PACKED elf64_ehdr {
...
typedef struct RABBITBONE_PACKED elf64_phdr {
    u32 p_type;
    u32 p_flags;
    u64 p_offset;
    u64 p_vaddr;
