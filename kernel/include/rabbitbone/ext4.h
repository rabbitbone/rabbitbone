#ifndef RABBITBONE_EXT4_H
#define RABBITBONE_EXT4_H
...
typedef struct RABBITBONE_PACKED ext4_superblock_disk {
    u32 s_inodes_count;
...
typedef struct RABBITBONE_PACKED ext4_group_desc_disk {
...
typedef struct RABBITBONE_PACKED ext4_inode_disk {
    u16 i_mode;
    u16 i_uid;
    u32 i_size_lo;
    u32 i_atime;
