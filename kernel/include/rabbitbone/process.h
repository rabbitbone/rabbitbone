#ifndef RABBITBONE_PROCESS_H
#define RABBITBONE_PROCESS_H
...
#define PROCESS_ENV_MAX RABBITBONE_ENV_MAX
#define PROCESS_NAME_MAX RABBITBONE_PROCESS_NAME_MAX
...
RABBITBONE_NORETURN void process_exit_current_from_syscall(cpu_regs_t *regs, i32 code);
...
bool process_current_credentials(rabbitbone_credinfo_t *out);
bool process_set_current_credentials(const rabbitbone_credinfo_t *cred);
...
RABBITBONE_NORETURN void process_exit_from_interrupt(i32 code);
RABBITBONE_NORETURN void process_fault_from_interrupt(u64 vector, u64 rip, u64 cr2);
