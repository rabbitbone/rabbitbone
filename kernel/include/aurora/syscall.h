...
typedef enum aurora_syscall_no {
    ...
    AURORA_SYSCALL_BRK = AURORA_SYS_BRK,
    AURORA_SYSCALL_SBRK = AURORA_SYS_SBRK,
    AURORA_SYSCALL_MMAP = AURORA_SYS_MMAP,
    AURORA_SYSCALL_MUNMAP = AURORA_SYS_MUNMAP,
    AURORA_SYSCALL_MPROTECT = AURORA_SYS_MPROTECT,
    AURORA_SYSCALL_SIGNAL = AURORA_SYS_SIGNAL,
    AURORA_SYSCALL_SIGACTION = AURORA_SYS_SIGACTION,
    AURORA_SYSCALL_SIGPROCMASK = AURORA_SYS_SIGPROCMASK,
    AURORA_SYSCALL_SIGPENDING = AURORA_SYS_SIGPENDING,
    AURORA_SYSCALL_KILL = AURORA_SYS_KILL,
    AURORA_SYSCALL_RAISE = AURORA_SYS_RAISE,
    AURORA_SYSCALL_GETPGRP = AURORA_SYS_GETPGRP,
    AURORA_SYSCALL_SETPGID = AURORA_SYS_SETPGID,
    AURORA_SYSCALL_GETPGID = AURORA_SYS_GETPGID,
    AURORA_SYSCALL_SETSID = AURORA_SYS_SETSID,
    AURORA_SYSCALL_GETSID = AURORA_SYS_GETSID,
    AURORA_SYSCALL_TCGETPGRP = AURORA_SYS_TCGETPGRP,
    AURORA_SYSCALL_TCSETPGRP = AURORA_SYS_TCSETPGRP,
    AURORA_SYSCALL_SIGRETURN = AURORA_SYS_SIGRETURN,
