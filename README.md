...
<p align="center">
  <img alt="Version" src="https://img.shields.io/badge/version-0.0.3.3-2f6fed" />
...
The current release line is `0.0.3.3`. The default path is UEFI-only. The legacy BIOS image is kept only for regression comparison via `make legacy-image`.
