...
![Version](https://img.shields.io/badge/version-0.0.2.11-2f6fed)
...
| Storage | PCI enumeration, AHCI SATA, ATA PIO fallback, driver-tagged block layer, MBR parsing, installer-built EXT4 seed partition |
...
kernel/drivers/        VGA, serial, PIT, PIC, keyboard, PCI, AHCI, ATA PIO, MBR, block layer
