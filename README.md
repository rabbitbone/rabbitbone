...
![Version](https://img.shields.io/badge/version-0.0.2.14-2f6fed)
...
| Processes | process registry, heap-backed fd model, async spawn, blocking wait/sleep, fork, exec, signal delivery/masking, process groups/sessions, terminal foreground groups, user heap/brk/sbrk/malloc, demand-paged anonymous, file-backed private, and fork-inherited anonymous shared mmap/munmap/mprotect |
