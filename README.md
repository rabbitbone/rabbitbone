...
![Version](https://img.shields.io/badge/version-0.0.2.8-2f6fed)
...
| Processes | process registry, heap-backed fd model, async spawn, blocking wait/sleep, fork, exec, user heap/brk/sbrk/malloc, anonymous and file-backed private mmap/munmap/mprotect |
